...
// check vị trí Assigning App Permissions
    private void AssigningAppPermissions(){
    ...
    //
    private void checkLocationSeting(){
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                try {
                                    ...
                                    rae.startResolutionForResult(HomeActivity.this, 0);
